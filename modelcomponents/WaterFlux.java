...
public class WaterFlux  {
	...
	public void computeFlux(Double fHb, Double cbenz2, Double buffer_conc,Double edgto, Double I_18) { //6
		...
		double diff = this.cell.Os.getConcentration() - this.medium.Os.getConcentration();
		this.setFlux((this.getPermeability()/I_18)*diff);
	}
